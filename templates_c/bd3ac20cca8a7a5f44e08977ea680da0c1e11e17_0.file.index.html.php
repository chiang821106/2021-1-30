<?php
/* Smarty version 3.1.36, created on 2021-01-31 14:01:16
  from 'C:\xampp\htdocs\2021-1-29\index.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_6016aa1c831a75_06253579',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bd3ac20cca8a7a5f44e08977ea680da0c1e11e17' => 
    array (
      0 => 'C:\\xampp\\htdocs\\2021-1-29\\index.html',
      1 => 1612098075,
      2 => 'file',
    ),
  ),
...
function content_6016aa1c831a75_06253579 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="zh">
                    ...
                    <td align="right" class="col">
                        <p>
                            <?php if ($_smarty_tpl->tpl_vars['page']->value == 1) {?>  
                                ...
                                <a class="text-light btn btn-info" href="#"style="visibility:hidden">擴充用</a>
                                <a class="text-light btn btn-info" href="index.php?page=<?php ob_start();
echo $_smarty_tpl->tpl_vars['page']->value+1;
$_prefixVariable1 = ob_get_clean();
echo $_prefixVariable1;?>
">下一頁</a>
                                <a class="text-light btn btn-info" href="index.php?page=<?php ob_start();
echo $_smarty_tpl->tpl_vars['page_end']->value;
...
">最末頁</a>
                            <?php } elseif ($_smarty_tpl->tpl_vars['page']->value < $_smarty_tpl->tpl_vars['total_page']->value && $_smarty_tpl->tpl_vars['page']->value != 1) {?>  
                                <a class="text-light btn btn-info" href="index.php?page=<?php ob_start();
echo $_smarty_tpl->tpl_vars['page']->value+1;
